An unzipping library based on [yauzl](https://github.com/thejoshwolfe/yauzl). This library provides abetter API and state management, while using the same low-level dserialization logic.
